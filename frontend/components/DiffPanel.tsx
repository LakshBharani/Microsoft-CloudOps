...
import { Upload, X, Plus, Pencil, Trash2, RefreshCw, ChevronDown, ChevronRight, GitBranch, CloudUpload, CloudDownload, Settings } from "lucide-react";
...
export default function DiffPanel({ subscriptionId, onDiff, onApply, onClose, onOpenSettings, result, loading, error, devOpsConfig }: Props) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#161b27] text-slate-200">
      <div className="px-4 py-2.5 border-b border-slate-700 flex items-center gap-2 flex-shrink-0 min-h-0">
